# Utilizando el patrón de diseño FACTORY caso: empresa de Delivery

# - La empresa tiene dos tipos de formas de delivery
#   ○ Terrestre: motocicletas
#   ○ Aerea: Drones
# - Las políticas de la empresa nos dicen que tenemos que limitar la
#   capacidad de entregas diarias por vehículo para mantenerlos en
#   buen estado, las motos llegan a 10 entregas por día y los drones a 20
#   entregas por día.
...
class DeliveryVehicle:
  ...
  def deliver(self):
    if self.packages_delivered < self.capacity:
      ...
      return "Entrega realizada con éxito"
    else:
      return "El vehículo ha alcanzado su capacidad máxima de entregas"

class Motrocycle(DeliveryVehicle):
  def __init__(self):
