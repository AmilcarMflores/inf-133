...
def create_animal():
  ...
  if not name or not specie or age is None:
    return jsonify({"error": "Faltan datos requeridos"}), 400
  
  # Crear un nuevo animal y guardarlo en la db
  animal = Animal(name=name, specie=specie, age=age)
  animal.save()
...
def update_animal(id):
  ...
  animal.update(name=name,specie=specie,age=age)
