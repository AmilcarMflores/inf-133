...
# Ruta de la página raíz redirige a la página de inicio de sesión
@user_bp.route("/")
def index():
...
# Definimos la ruta /users asociada a la función registro que nos devuelve la vista de registro
...
# Ya estamos en la vista de actualizar por lo que obtenemos los datos del formulario y actualizamos la información del usuario
